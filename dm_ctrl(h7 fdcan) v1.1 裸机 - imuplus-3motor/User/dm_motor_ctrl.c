...
void dm_motor_init(void)
{
    ...
    motor[Motor1].ctrl.mode     = mit_mode;    // MIT 
    motor[Motor1].ctrl.vel_set  = 0.0f;        // 1rad/s=10rpm
    motor[Motor1].ctrl.pos_set  = 0.0f;			//弧度
    motor[Motor1].ctrl.tor_set  = 0.0f;
    motor[Motor1].ctrl.cur_set  = 0.0f;
    motor[Motor1].ctrl.kp_set   = 0.0f;        
    motor[Motor1].ctrl.kd_set   = 0.0f;        
    // DM3510 PMAX VMAX TMAX
    motor[Motor1].tmp.PMAX      = 12.5f;
    motor[Motor1].tmp.VMAX      = 30.0f;
    motor[Motor1].tmp.TMAX      = 1.0f;

    // Motor2
    motor[Motor2].id = 0x02;
    motor[Motor2].mst_id = 0x12;        
    motor[Motor2].tmp.read_flag = 1;
    motor[Motor2].ctrl.mode     = mit_mode;    // MIT 
    motor[Motor2].ctrl.vel_set  = 0.0f;        // 1rad/s=10rpm
    motor[Motor2].ctrl.pos_set  = 0.0f;			//弧度
    ...
    motor[Motor2].tmp.TMAX      = 1.0f;

	// Motor3
    motor[Motor3].id = 0x03;
    motor[Motor3].mst_id = 0x13;        
    motor[Motor3].tmp.read_flag = 1;
    motor[Motor3].ctrl.mode     = mit_mode;    // MIT 
    motor[Motor3].ctrl.vel_set  = 0.0f;        // 1rad/s=10rpm
    motor[Motor3].ctrl.pos_set  = 0.0f;			//弧度
